...
"""
function mcapplytoall!(gate::CliffordGate, psum::VectorPauliSum; squared=false, kwargs...)
...
function mcapplytoall!(gate::PauliRotation, psum::VectorPauliSum, theta; squared=false, kwargs...)
    power = squared ? 2 : 1
...
function mcapplytoall!(gate::FrozenGate, psum::VectorPauliSum; kwargs...)
    return mcapplytoall!(gate.gate, psum, gate.parameter; kwargs...)
end